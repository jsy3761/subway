...
AmCharts.themes.theme_02 = {
  ...
  AmSerialChart: {
    fontFamily:"segoe ui",
    autoMargins: true,      /*0625수정*/
    autoMarginOffset: 12,     /*0625수정*/
    // marginTop: 20,           /*0625수정*/
    // marginRight: 30,         /*0625수정*/
    // marginLeft: 20,           /*0625수정*/
    // marginBottom: 30,        /*0625수정*/
  ...
  AxisBase: { //x축, y축, grid style
    fontSize: 11,
    axisColor: "#cfd0d3", // x,y축 line color  /*0625수정*/
    axisAlpha: 1,                              /*0625수정*/
    gridColor: "#dedede", // line color
    gridAlpha: 1,
    // inside: true,          /*0625수정*/
    labelOffset: 6,
    axisThickness: 1,          /*0625수정*/
  ...
  CategoryAxis: { //x축
    ...
    // axisAlpha: 1,
    labelOffset: -3,             /*0625수정*/
    gridAlpha: 0,
    // showFirstLabel: false,    /*0625수정*/
    showLastLabel: false
    //tickPosition: "start" //colum 차트 tick 지정
  },
  ValueAxis: { //y축
    axisAlpha: 0,    /*0625수정*/
    axisThickness: 0,  /*0625수정*/
    labelOffset: -2,  /*0625수정*/
    ...
    AmCharts.makeChart($chartType_line01_array[i],
      {
        ...
        // "autoMargins":false,  /*0625수정*/
        // "marginBottom": 30,   /*0625수정*/
        // "marginLeft": 0,      /*0625수정*/
        // "marginRight": -1,    /*0625수정*/
        // "marginTop": 22,      /*0625수정*/
        "categoryAxis": {
          "minPeriod": "mm"
          // "inside": false,    /*0625수정*/
    ...
    AmCharts.makeChart($chartType_line03_array[i],
      {
        ...
        "categoryField": "date",
        "dataDateFormat": "YYYY-MM-DD HH:NN",
        // "marginTop": 7, // right legend list  /*0625수정*/
        "categoryAxis": {
          "minPeriod": "mm"
        },
        "chartCursor": {
    ...
    AmCharts.makeChart($chartType_area12_array[i],
      {
        ...
        "categoryField": "date",
        "dataDateFormat": "YYYY-MM-DD HH:NN",
        "marginTop": 20, //Legend align-right 1 line  /*0625수정*/
        "categoryAxis": {
          "minPeriod": "mm"
        },
        "chartCursor": {
